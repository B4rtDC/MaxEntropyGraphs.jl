...
# ╔═╡ 67d02f04-0be1-11ec-1b5d-651e122f0aa3
begin
	using Symbolics
	using Latexify
	const n = 5
...
# ╔═╡ fd6a4d6e-4312-40b1-b74d-ed40cf7f0a28
...
# ╔═╡ d49b1527-337d-4673-b820-30f0104bf8b6
let
	
	@variables A[1:n, 1:n]
	f_expr = build_function([sum(A), maximum(A)], A)[1]
end

# ╔═╡ d0934549-a828-4e82-a18e-9676c569351c
function degree(x::Symbolics.Arr)
	return sum(x, dims=1)
end

# ╔═╡ 9afa8e94-f703-4bb0-b03a-c13588a459e0
r = sum(Symbolics.scalarize(A), dims=2)[1]

# ╔═╡ febb44b9-5dd7-416d-b34c-8f46d04a5d33
d = Differential(A[1,2]) * Differential(A[1,3])

# ╔═╡ e025981a-d83b-4804-8186-c76ec1f30288
expand_derivatives(d(r))

# ╔═╡ b19c0a7a-5df8-4065-b6e6-2401fc753886
b = sum(A,dims=1);

# ╔═╡ 36a3c2d3-80e8-4c30-a3df-1edc4a82e26c
typeof(A)

# ╔═╡ d593d8b7-9d8a-4efe-9191-f3a1255a41bf
Symbolics.Arr <: Array

# ╔═╡ 8e6232ff-1e29-4f16-944c-fe72ee5440f1
begin
	A[1,2]
	dA = Differential(A)
	res = 	expand_derivatives(dA(A))
	typeof(res)
end

# ╔═╡ 0b6dbc26-75e2-4b14-bd83-6776344c8338
